...
export default function Navbar() {
    return (
      ...
      <div className="md:mx-[15%] flex sticky top-0 p-2 bg-black">
       <a href="/"> <img src="https://www.dellaleaders.com/images/logo.svg" width="50px"></img></a>
        ...
        <p>|</p>
        <a href="/Login"><button className=" p-2 bg-red-600 rounded-xl w-16 border-solid border-2 border-black hover:border-white hover:bg-black ">Login</button></a>
        </div>
      </div>
    )
  }
